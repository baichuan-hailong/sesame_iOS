...
@interface ZMMarketingViewController ()
...
@implementation ZMMarketingViewController
...
- (void)meneBtnAction:(UIButton *)sender {
    ...
    ZMMarketingPublishViewController *publishView = [[ZMMarketingPublishViewController alloc] init];
...
- (UIImageView *)backImage {
    ...
    if (_backImage == nil) {
        ...
        _backImage.image = [UIImage imageNamed:@"mm_赚推介费背景"];
    }
    return _backImage;
}
...
- (UIScrollView *)menuScrollerView {
    ...
    if (_menuScrollerView == nil) {
        ...
        _menuScrollerView.contentSize = CGSizeMake(SCREEN_WIDTH + 1, SCREEN_WIDTH/1.72);
...
- (UIButton *)btn1 {
    ...
    if (_btn1 == nil) {
        ...
        UIImage *img = [UIImage imageNamed:@"mm_开发商"];
...
- (UIButton *)btn3 {
    ...
    if (_btn3 == nil) {
        _btn3 = [[UIButton alloc] initWithFrame:CGRectMake/*(self.menuScrollerView.centerX - SCREEN_WIDTH/2.5 - SCREEN_WIDTH/37.5,
                                                           ...
                                                           SCREEN_WIDTH/2.5,
                                                           (SCREEN_WIDTH/2.5)/1.5)*/
                                                          (self.menuScrollerView.centerX + SCREEN_WIDTH/37.5,
                                                           0,
                                                           SCREEN_WIDTH/2.5,
                                                          (SCREEN_WIDTH/2.5)/1.5)];
        _btn3.tag = 3;
        ...
        UIImage *img = [UIImage imageNamed:@"mm_买房"];
...
- (UIButton *)btn4 {
    ...
    if (_btn4 == nil) {
        _btn4 = [[UIButton alloc] initWithFrame:CGRectMake/*(self.menuScrollerView.centerX + SCREEN_WIDTH/37.5,
                                                           ...
                                                           SCREEN_WIDTH/2.5,
                                                           (SCREEN_WIDTH/2.5)/1.5)*/
                                                          (self.menuScrollerView.centerX - SCREEN_WIDTH/2.5 - SCREEN_WIDTH/37.5,
                                                           self.menuScrollerView.height - (SCREEN_WIDTH/2.5)/1.5,
                                                           SCREEN_WIDTH/2.5,
                                                          (SCREEN_WIDTH/2.5)/1.5)];
        _btn4.tag = 4;
...
- (UIButton *)tipsBtn {
    ...
    if (_tipsBtn == nil) {
        ...
        [_tipsBtn setTitle:@"更多房地产业务，我要推介 >" forState:UIControlStateNormal];
...
- (UILabel *)titleLable {
    ...
    if (_titleLable == nil) {
        ...
        _titleLable.text = @"推介具体产品或服务，赚取推介费";
...
- (UILabel *)tipsLable1 {
    ...
    if (_tipsLable1 == nil) {
        ...
        _tipsLable1.text = @"提交信息写明要推介的产品或服务";
...
- (UILabel *)tipsLable2 {
    ...
    if (_tipsLable2 == nil) {
        ...
        _tipsLable2.text = @"平台帮您与指定供应商接洽，签署居间协议";
...
- (UILabel *)detailLable {
    ...
    if (_detailLable == nil) {
        ...
        _detailLable.text = @"您在工作和生活中，“顺便”向您的朋友推介了某一产品或服务，但您无法直接与这个产品提供商或服务商联络并获益。您只需将信息提交给平台，平台帮助接洽他们，并作为第三方参与签约。如成交，平台开发票并保障您获得“推介费”";
