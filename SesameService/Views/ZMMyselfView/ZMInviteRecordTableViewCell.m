...
@interface ZMInviteRecordTableViewCell ()
@property(nonatomic,strong)UIView *line;
@end

@implementation ZMInviteRecordTableViewCell
...
-(void)setRecord:(NSDictionary *)recDic{
    ...
    self.nameLabel.text = [NSString stringWithFormat:@"%@",recDic[@"person_name"]];
...
-(UILabel *)nameLabel{
    if (_nameLabel==nil) {
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/375*17.5,
