//
//  ZMMyCreditLeftOneTableViewCell.m
//  SesameService
//
...
@interface ZMMyCreditLeftOneTableViewCell ()
...
@implementation ZMMyCreditLeftOneTableViewCell
...
-(UIView *)leftLine{
    if (_leftLine==nil) {
        _leftLine = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/375*64,
                                                             SCREEN_WIDTH/375*99-SCREEN_WIDTH/375*64,
                                                             SCREEN_WIDTH/375*1,
                                                             SCREEN_WIDTH/375*64)];
    }
    return _leftLine;
...
-(UIView *)point{
    if (_point==nil) {
        _point = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/375*61,
                                                          SCREEN_WIDTH/375*28+SCREEN_WIDTH/375*99-SCREEN_WIDTH/375*64,
                                                          SCREEN_WIDTH/375*7,
                                                          SCREEN_WIDTH/375*7)];
    }
    return _point;
...
-(UIView *)bottomLine{
    if (_bottomLine==nil) {
        _bottomLine = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/375*79,
                                                               SCREEN_WIDTH/375*98,
                                                               SCREEN_WIDTH-SCREEN_WIDTH/375*79,
                                                               SCREEN_WIDTH/375*1)];
    }
    return _bottomLine;
}
...
-(UILabel *)scoreLabel{
    if (_scoreLabel==nil) {
        _scoreLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/375*15,
                                                                SCREEN_WIDTH/375*21+SCREEN_WIDTH/375*99-SCREEN_WIDTH/375*64,
                                                                SCREEN_WIDTH/375*40,
                                                                SCREEN_WIDTH/375*20)];
    }
    return _scoreLabel;
...
-(UILabel *)titleLabel{
    if (_titleLabel==nil) {
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/375*91,
                                                                SCREEN_WIDTH/375*18+SCREEN_WIDTH/375*99-SCREEN_WIDTH/375*64,
                                                                SCREEN_WIDTH-SCREEN_WIDTH/375*110,
                                                                SCREEN_WIDTH/375*34)];
    }
    return _titleLabel;
}
